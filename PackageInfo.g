#############################################################################
##  
##  PackageInfo.g for the package `SystemTheory'              Thomas Cluzeau
##                                                             Alban Quadrat
...
#
PackageName := "SystemTheory",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "A homalg based package for system theory",

##  See '?Extending: Version Numbers' in GAP help for an explanation
##  of valid version numbers. For an automatic package distribution update
##  you must provide a new version number even after small changes.
Version := Maximum( [
  "2011.06.17", ## Alban's version
...
# 
ArchiveURL := Concatenation( "http://www-sop.inria.fr/members/Alban.Quadrat/SystemTheory/SystemTheory-", ~.Version ),
...
Persons := [
  rec(
    ...
    WWWHome       := "http://perso.ensil.unilim.fr/~cluzeau/",
    PostalAddress := Concatenation( [
                       ...
                       "France" ] ),
    Place         := "Limoges",
    Institution   := "École Nationale Supérieure d'Ingénieurs de Limoges"
  ),
  rec(
    LastName      := "Quadrat",
    FirstNames    := "Alban",
...
PackageDoc := rec(
  ...
  LongTitle := "A homalg based package for system theory",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "k-Points", ">= 2011.06.23" ], [ "AbelianSystems", ">= 2011.07.01" ], [ "homalg", ">= 2011.06.21" ], [ "D-Modules", ">= 2011.06.29" ], [ "Modules", ">= 2011.06.30" ], [ "RingsForHomalg", ">= 2011.06.30" ], [ "HomalgToCAS", ">= 2011.08.10" ], [ "MatricesForHomalg", ">= 2011.08.10" ], [ "GAPDoc", ">= 1.0" ] ],
...
#  "  ?SystemTheory:x            ## for chapter/section/topic x\n",
#  "----------------------------------------------------------------\n" ),
#
...
Keywords := [ "system theory", "direct sum decomposition" ]
