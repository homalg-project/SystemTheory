...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "k-Points", ">= 2011.06.23" ], [ "AbelianSystems", ">= 2011.07.01" ], [ "homalg", ">= 2011.06.21" ], [ "D-Modules", ">= 2011.06.29" ], [ "Modules", ">= 2011.06.30" ], [ "RingsForHomalg", ">= 2011.06.30" ], [ "MatricesForHomalg", ">= 2011.06.29" ], [ "GAPDoc", ">= 1.0" ] ],
